...
{
    if(url.scheme() != QString("weedcoin"))
        return false;
...
{
    // Convert weedcoin:// to weedcoin:
    //
    //    Cannot handle this later, because weedcoin:// will cause Qt to see the part after // as host,
    //    which will lowercase it (and thus invalidate the address).
    if(url.startsWith("weedcoin://"))
    {
        url.replace(0, 11, "weedcoin:");
    }
