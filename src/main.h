...
static const int64 MIN_TX_FEE = 10000000; // weedcoin: minimum transaction fee of 0.1 LTC
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE; // weedcoin: minimum relay transaction fee same as minimum transaction fee.
static const int64 MAX_MONEY = 168000000 * COIN; // weedcoin: maximum of 840k coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // weedcoin: 576 blocks found a day. Priority cutoff is 1 weedcoin day / 250 bytes.
    }
