...
Intro
-----
weedcoin is a free open source peer-to-peer electronic cash system that is
...
Setup
-----
Unpack the files into a directory and run weedcoin-qt.exe.
...
but allowing incoming connections helps the weedcoin network.
